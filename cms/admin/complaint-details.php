...
<head>
	...
	<title>Admin| E-Complaint Details</title>
...
//$queryy=mysqli_query($con,"insert into deptcomplaints(cmpno) values('$cmpno')");
...
<!--
											<form method="post">
											<label for="department"> Assign Task </label>

<select name="department">
<option value="Warehouse Manager">Warehouse Manager</option>
  <option value="Custom Manager">Custom Manager </option>
