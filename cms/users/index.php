...
?>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<!-- <h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">E Complaint Managent System</a></h3> -->
	
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading">sign in now</h2>
		        <p style="padding-left:4%; padding-top:2%;  color:red">
		        	<?php if($errormsg){
echo htmlentities($errormsg);  ?></p>
 <script>
            swal("Something wrong!", "Invalid Username or Password!", "error");
        </script>
		        	...
		        	<?php if($msg){ ?>
						<script>
            swal("Welcome Back!", "You have logged in!", "success");
        </script> <?php
