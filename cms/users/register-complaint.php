...
$query=mysqli_query($con,"insert into tblcomplaints(userId,category,subcategory,complaintType,state,noc,complaintDetails,priority,complaintFile) values('$uid','$category','$subcat','$complaintype','$state','$noc','$complaintdetials','$priority','$compfile')");
...
<script>
						flasher.success('Complain Registered successfully!');
						</script>
            <?php
...
<html lang="en">
  <head>
    ...
    <title>E-CMS | User Register Complaint</title>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <?php echo htmlentities($successmsg); ?>
                       <script>
                       swal("Thank You!", "Your Complaint has registered !", "success");
                   </script>
...
<label for="department">Urgent or not </label>

<select name="priority" id="priority">
<option value="1">It's Urgent to Resolve</option>
  <option value="2">Can be delay </option>
